...
NidorinaEvosAttacks:
	dbbw EVOLVE_ITEM, MOON_STONE, EKANS
	db 0 ; no more evolutions
	dbw 1, GROWL
	dbw 1, TACKLE
	dbw 8, SCRATCH
...
VulpixEvosAttacks:
	dbbw EVOLVE_ITEM, FIRE_STONE, EKANS
	db 0 ; no more evolutions
	dbw 1, EMBER
	dbw 1, TAIL_WHIP
	dbw 7, QUICK_ATTACK
...
GloomEvosAttacks:
	dbbw EVOLVE_ITEM, LEAF_STONE, EKANS
	dbbw EVOLVE_ITEM, SUN_STONE, EKANS
	db 0 ; no more evolutions
	dbw 1, ABSORB
	dbw 1, POUND
	dbw 1, POISONPOWDER
...
PoliwhirlEvosAttacks:
	dbbw EVOLVE_ITEM, WATER_STONE, EKANS
	dbbw EVOLVE_TRADE, KINGS_ROCK, EKANS
	db 0 ; no more evolutions
	dbw 1, POUND
	dbw 1, HYPNOSIS
	dbw 1, WATER_GUN
...
ChanseyEvosAttacks:
	dbbw EVOLVE_HAPPINESS, TR_ANYTIME, EKANS
	db 0 ; no more evolutions
	dbw 1, POUND
	dbw 5, GROWL
	dbw 9, TAIL_WHIP
...
SeadraEvosAttacks:
	dbbw EVOLVE_TRADE, DRAGON_SCALE, EKANS
	db 0 ; no more evolutions
	dbw 1, POUND
	dbw 1, SMOKESCREEN
	dbw 1, LEER
...
ScytherEvosAttacks:
	dbbw EVOLVE_TRADE, METAL_COAT, EKANS
	db 0 ; no more evolutions
	dbw 1, QUICK_ATTACK
	dbw 1, LEER
	dbw 6, FOCUS_ENERGY
...
PorygonEvosAttacks:
	dbbw EVOLVE_TRADE, UP_GRADE, EKANS
	db 0 ; no more evolutions
	dbw 1, CONVERSION2
	dbw 1, TACKLE
	dbw 1, CONVERSION
